{
  ...
  cfg = config.x-next.services.cowsay-mastodon-poster;
  ...
  '';
in {
  options.x-next.services.cowsay-mastodon-poster = with types; {
    enable = mkBoolOpt false "Whether or not to enable cowsay posts.";
    short = mkBoolOpt false "Use short fortunes only.";
    user = mkOpt str config.x-next.user.name "The user to run as.";
